...
2. The number of pass rushers shows a stronger relationship with playResult (Estimate coefficient = 0.381, P-value = 0.000162), compared to defenders in the box (P-value = 0.985).  
...
## XGBoost Results
    ...
    -Test RMSE: 9.83
    -Slight improvements could be the result of less overfitting and presence of        
